...
both pass. The 0.2.0 release ran with `--skip-gate` for this reason. On
2026-09-25 every gate run on the owner's machine passed on Node 26.10, and
the 0.3.0 release ran the full gate. Find
