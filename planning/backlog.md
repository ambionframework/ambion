...
The journal side no longer has this gap: the composition row and every seating
...
can both start work. F4 and F5: the audit journal of a seat has no activation id on its rows and
