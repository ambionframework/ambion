...
| E Evals                  | The assistant's live suite runs on `@ambionframework/simulator`, with three cases over several exchanges and four cases of the assistant's purpose. It must pass on two model families at `medium` thinking, each graded by the other. [Simulator](../docs/simulator.md) holds the design.                                                                                                                         |
