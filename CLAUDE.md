...
| `docs/processes.md`       | Design contract for background processes: `bash`, `ps`, `status`, `wait`, `cancel`, handles, output files, reminders, and the cancel at the end of an exchange — read with `workspace.md` |
