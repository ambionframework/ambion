...
| `docs/bash.md`            | Design contract for the `bash` tool and the background jobs it starts: handles, output files, and `status`, `wait`, and `cancel` — read with `workspace.md` |
