...
| `docs/job.md`          | Design contract for jobs: agent-written programs that the workspace runs, and watches that turn a job's notices into activations — pending, not implemented |
