...
const ORDINARY_GUIDANCE = [
	...
	'Tasks run in their working rooms in the background, including work by this same agent. Continue engaging the current room while a Task runs, and use Task updates or steering only when they add useful direction.',
