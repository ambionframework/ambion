...
export function readPosition(after: number, scanned: number | undefined): number {
	//@ ensures \result >= after
	//@ ensures scanned != undefined ==> \result >= scanned
	//@ ensures scanned == undefined ==> \result == after
