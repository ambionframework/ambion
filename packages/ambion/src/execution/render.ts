...
const MECHANISM = [
	...
	`what is said; nobody sees your tool use. A room has a URI, and an exchange has the URI`,
	`<room URI>/exchange/<n>. The context gives the room's URI, and the ask line at its end`,
	`gives the current exchange.`,
].join('\n');
