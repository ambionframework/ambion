...
| The activation lifecycle and the exchange lifecycle: the lease, the admissions, the grant, the steer, the verdict, the pass, the close | [`room/rules.verified.ts`](../packages/ambion/src/room/rules.verified.ts)                                                                            |
