...
| Every decision the room makes over its fold: the lease, the retry, the transitions, the routing, the exchange, the roster | [`room/rules.verified.ts`](../packages/ambion/src/room/rules.verified.ts)                                                                            |
