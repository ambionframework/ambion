...
| Every decision the room makes over its fold: the lease, the transitions, the pass, the grant, the verdict, the routing, presence, the roster, the message list | [`room/rules.verified.ts`](../packages/ambion/src/room/rules.verified.ts), [`rules.roster.verified.ts`](../packages/ambion/src/room/rules.roster.verified.ts), [`rules.record.verified.ts`](../packages/ambion/src/room/rules.record.verified.ts) |
