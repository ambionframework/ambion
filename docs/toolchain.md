...
| ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------- |
| `types`, `wire`, `define`, `assistant`, `render` | Pure vocabulary and assistant policy: public shapes, wire values, eligibility, and participant context                               | Nothing that does anything            |
