...
| Git on a workstation           | The workstation carries the git transport `ssh` of `workstationGitBackend`. [Workstation git](workstation-git.md#trust) states the rows.                                                                                                                                                               | [Git](git.md#on-a-workstation)                                                                    |
