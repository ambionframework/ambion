...
| Git on a workstation           | The workstation carries no git transport until G2 of [the plan](../planning/next.md#g-git-on-the-workstation).                                                                                                                                                                                         | [Git](git.md#on-a-workstation)                                                                    |
