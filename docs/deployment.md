...
`runtime.evict(name)` drops local handles and observers without writing
departures or releasing leases. Neither operation closes one client's
connection while keeping the room active.
