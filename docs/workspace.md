...
**Assistant activations do not expose workspace tools.** An assistant
may name a workspace on its definition. Its opening activation receives
only `seat`, and its closing activation receives only `summarise`.
Workspace tools belong to ordinary message activations.
